      ...
      <main className="home">
        ...
        <section>
          <p className="typography__mono">
            Heyoooo! Welcome! My name is Jon Major Condon. I'm a Creative based
            in Wisconsin. I am a full-time Software Engineer, and I make stories
        ...
        <section className="spacing">
          <div className="home__quote">
            <blockquote>
              If you make things and share them, your heart will at some point
              be broken. If you never share, it will harden. Your choice. ~ Todd
              henry
            </blockquote>
          </div>
        </section>
